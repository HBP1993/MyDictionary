...
"""
print()
print("*****  start section 8 - get and clear methdo ********")
print()
...
"""
print()
print("*****  start section 9 - using using pop and popitem ********")
print()
...
# random_phone = list(phonebook)
# print(random_phone)
# choice = random.choice(random.phone)
# print(choice)
